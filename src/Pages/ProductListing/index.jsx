...
const ProductListing = () => {
  ...
  <Button
    className={`!w-[40px] !h-[40px] !min-w-[40px] !rounded-full !text-[#000] ${itemView === "list" ? "!bg-black !text-white" : ""}`}
    onClick={() => setItemView('list')}
  >
    <LuMenu className='text-[rgba(255, 255, 255, 0.7)]' />
  </Button>

  <Button
    className={`!w-[40px] !h-[40px] !min-w-[40px] !rounded-full !text-[#000] ${itemView === "grid" ? "!bg-black !text-white" : ""}`}
    onClick={() => setItemView('grid')}
  >
    <IoGridSharp className='text-[rgba(255, 255, 255, 0.7)]' />
  </Button>
