        ...
        <div className="col2 !w-[80%]">
          <div className="shadow-md rounded-md bg-white">
            <div className="!py-5 !px-3 !border-b !border-[rgba(0,0,0,0.1)]">
              <h2 className="myList text-xl font-semibold">My Orders</h2>
              ...
              <table className="!w-full text-sm text-left rtl:text-right text-gray-600">
                ...
                <tbody>
                  <tr className="bg-[#fafafa] border-b border-gray-300">
                    ...
                    <td className="!px-6 !py-4 font-[500]">
                      <span className="text-primary">96748367527357263725</span>
                    </td>
                    <td className="!px-6 !py-4 font-[500]">
                      <span className="text-primary">pay_7527325</span>
                    </td>
                          ...
                          <table className="!w-full text-sm text-left rtl:text-right text-gray-500">
                            ...
                            <tbody>
                              <tr className="bg-[#fafafa] border-b">
                                <td className="!px-6 !py-4 font-[500]">96748367527357263725</td>
                                <td className="!px-6 !py-4 font-[500]">A-Line Kurti with Sharara & Dupatta</td>
                                <td className="!px-6 !py-4 font-[500]">
                                  <img
                                    src="https://www.myntra.com/kurta-sets/sangria/sangria-a-line-kurti-with-sharara--dupatta/30619834/buy"
                  ...
                  <tr className="bg-[#fafafa] border-b border-gray-300">
                    ...
                    <td className="!px-6 !py-4 font-[500] whitespace-nowrap">RINKU VERMA</td>
                    <td className="!px-6 !py-4 font-[500]">9758648657</td>
                    <td className="!px-6 !py-4 font-[500]">
                      <span className='block w-[400px]'> John Smith, 123 Main Street, Apt 4B, Anytown, CA 91234, USA</span>
                    </td>
                    <td className="!px-6 !py-4 font-[500]">110033</td>
                    <td className="!px-6 !py-4 font-[500]">434</td>
                    <td className="!px-6 !py-4 font-[500]">rahdj@gmail.com</td>
                    <td className="!px-6 !py-4 font-[500]">
                      <span className="text-primary">U8189cf6745fc0d808977bdb0b9f22995</span>
                    </td>
                    <td className="!px-6 !py-4 font-[500]">
                    ...
                    <td className="!px-6 !py-4 font-[500] whitespace-nowrap">2024-06-17</td>
                  </tr>
